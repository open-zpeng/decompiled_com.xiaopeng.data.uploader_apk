...
public class c {
    ...
    private SharedPreferences.Editor f1822a = null;
    ...
    */
    ...
    private void c() {
        ...
        if (this.f1822a == null && (sharedPreferences = this.f117a) != null) {
            this.f1822a = sharedPreferences.edit();
        }
    ...
    */
    public boolean commit() {
        /*
            ...
            android.content.SharedPreferences$Editor r2 = r6.f1822a
            r3 = 0
            if (r2 == 0) goto L20
            boolean r4 = r6.j
            if (r4 != 0) goto L16
            ...
            r2.putLong(r4, r0)
        L16:
            android.content.SharedPreferences$Editor r0 = r6.f1822a
    ...
    public void putString(String str, String str2) {
        ...
        c();
        SharedPreferences.Editor editor = this.f1822a;
        if (editor != null) {
