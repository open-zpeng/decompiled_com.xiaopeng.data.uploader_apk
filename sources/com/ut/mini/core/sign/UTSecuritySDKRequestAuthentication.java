...
public class UTSecuritySDKRequestAuthentication implements IUTRequestAuthentication {
    ...
    private Object f1851b = null;

    /* renamed from: c  reason: collision with root package name */
    private Object f1852c = null;

    /* renamed from: a  reason: collision with root package name */
    private Class f1850a = null;
    ...
    */
    ...
    public String getSign(String str) {
        ...
        if (this.g == null) {
            ...
            return null;
        } else if (str == null || this.f1851b == null || (cls = this.f1850a) == null || this.f132a == null || this.f134b == null || this.f135c == null || this.f133a == null || this.f1852c == null) {
            return null;
        } else {
            try {
                ...
                return (String) this.f133a.invoke(this.f1852c, newInstance, this.ad);
