...
public class UTPluginMgr implements UTMCAppStatusCallbacks {
    ...
    private static UTPluginMgr f1857a = new UTPluginMgr();

    /* renamed from: b  reason: collision with root package name */
    private HandlerThread f1858b = null;
    ...
    private void K() {
        ...
        this.f1858b = handlerThread;
        handlerThread.start();
        this.mHandler = new Handler(this.f1858b.getLooper()) { // from class: com.ut.mini.plugin.UTPluginMgr.2
