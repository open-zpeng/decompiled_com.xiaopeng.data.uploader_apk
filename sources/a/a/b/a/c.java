    ...
    */
    private static android.view.animation.Interpolator a(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, org.xmlpull.v1.XmlPullParser r5) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        Lca:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: a.a.b.a.c.a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }
    ...
    public static Interpolator b(Context context, int i) throws Resources.NotFoundException {
        ...
        try {
            try {
                if (i == 17563663) {
                    return new a.a.c.h.r.a();
                }
                if (i == 17563661) {
                    return new a.a.c.h.r.b();
                }
                if (i == 17563662) {
                    return new a.a.c.h.r.c();
                }
