...
public class b {
    ...
    public static boolean b(C0005b[] c0005bArr, C0005b[] c0005bArr2) {
        ...
        for (int i = 0; i < c0005bArr.length; i++) {
            if (c0005bArr[i].f209a != c0005bArr2[i].f209a || c0005bArr[i].f210b.length != c0005bArr2[i].f210b.length) {
                return false;
            }
        }
        return true;
    ...
    */
    private static void g(java.lang.String r8, int r9, a.a.c.b.b.a r10) {
        /*
            r0 = 0
            r10.f208b = r0
            r1 = r9
        ...
        L3d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: a.a.c.b.b.g(java.lang.String, int, a.a.c.b.b$a):void");
    }
    ...
    public static void j(C0005b[] c0005bArr, C0005b[] c0005bArr2) {
        for (int i = 0; i < c0005bArr2.length; i++) {
            c0005bArr[i].f209a = c0005bArr2[i].f209a;
            for (int i2 = 0; i2 < c0005bArr2[i].f210b.length; i2++) {
                c0005bArr[i].f210b[i2] = c0005bArr2[i].f210b[i2];
            }
        }
    }
    ...
    public static class C0005b {
        ...
        public static void e(C0005b[] c0005bArr, Path path) {
            ...
            char c2 = 'm';
            for (int i = 0; i < c0005bArr.length; i++) {
                a(path, fArr, c2, c0005bArr[i].f209a, c0005bArr[i].f210b);
                c2 = c0005bArr[i].f209a;
            }
        }
        ...
        public void d(C0005b c0005b, C0005b c0005b2, float f) {
            int i = 0;
            while (true) {
                float[] fArr = c0005b.f210b;
                if (i >= fArr.length) {
                    return;
                }
                this.f210b[i] = (fArr[i] * (1.0f - f)) + (c0005b2.f210b[i] * f);
                i++;
            }
        }

        C0005b(C0005b c0005b) {
            this.f209a = c0005b.f209a;
            float[] fArr = c0005b.f210b;
            this.f210b = b.c(fArr, 0, fArr.length);
        }
    }
}
